...
namespace EMTASS_ServerDemo {
    ...
    public class TTestSession : TSessionBase {
        ...
        protected override void AnalyzeDatagram(byte[] datagramBytes) {
            ...
            string datagramText = Encoding.ASCII.GetString(datagramBytes).Replace("<", "").Replace(">", "");
            ModelMember member = (ModelMember)db.StringtoClass(datagramText, "VCDS");


            base.SendDatagram("ok,rec you email:" + member.email);
