...
namespace X_Quartz.Simpl
{
	...
	/// between the various environments in which X_Quartz runs (e.g. disparate 
	/// application servers, stand-alone, mobile devices, etc.).  Because of this
	/// disparity, X_Quartz ran into difficulty with a one class-load style fits-all 
	...
	public class CascadingClassLoadHelper : ITypeLoadHelper
	{
		...
		*/
		...
		/// thread, which is the thread that is initializing X_Quartz.
		/// </summary>
