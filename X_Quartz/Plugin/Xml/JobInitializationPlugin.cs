...
namespace X_Quartz
{
    ...
    /// can be set with X_Quartz configuration. Attribute can be used to advice
...
namespace X_Quartz.Plugin.Xml
{
    ...
    public class JobInitializationPlugin : ISchedulerPlugin, IFileScanListener
    {
        ...
        public virtual void Initialize(string pluginName, IScheduler sched)
        {
            ...
            Log.Info("Registering X_Quartz Job Initialization Plug-in.");
