...
namespace X_Quartz.Plugin.Management
{
    /// <summary> 
    ...
    public class ShutdownHookPlugin : ISchedulerPlugin
    {
        ...
        public virtual void Initialize(string pluginName, IScheduler sched)
        {
            ...
            Log.Info(string.Format(CultureInfo.InvariantCulture, "Registering X_Quartz Shutdown hook '{0}.", name));
        ...
        {
            Log.Info("Shutting down X_Quartz...");
            try
            {
            ...
            {
                Log.Info("Error shutting down X_Quartz: " + e.Message, e);
            }
        }
