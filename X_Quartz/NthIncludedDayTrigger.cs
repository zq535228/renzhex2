...
namespace X_Quartz
{
	...
	public class NthIncludedDayTrigger : Trigger
	{
		...
		{
            return (misfireInstruction == X_Quartz.MisfireInstruction.NthIncludedDayTrigger.DoNothing) 
                || (misfireInstruction == X_Quartz.MisfireInstruction.NthIncludedDayTrigger.FireOnceNow)
		...
		public override void UpdateAfterMisfire(ICalendar cal)
		{
			...
			if (instruction == X_Quartz.MisfireInstruction.SmartPolicy)
			{
				instruction = X_Quartz.MisfireInstruction.NthIncludedDayTrigger.FireOnceNow;
			}

			if (instruction == X_Quartz.MisfireInstruction.NthIncludedDayTrigger.DoNothing)
			{
                nextFireTimeUtc = GetFireTimeAfter(DateTime.UtcNow);
			}
			else if (instruction == X_Quartz.MisfireInstruction.NthIncludedDayTrigger.FireOnceNow)
			{
