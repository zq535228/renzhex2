...
namespace X_Quartz.Xml
{
	...
	public class JobSchedulingDataProcessor
	{
		...
		public const string PropertyQuartzSystemIdDir = "X_Quartz.system.id.dir";
		...
		public const string QuartzXsdResourceName = "X_Quartz.X_Quartz.Xml.job_scheduling_data.xsd";
