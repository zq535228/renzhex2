...
namespace X_Quartz
{
	...
	public class SimpleTrigger : Trigger
	{
		...
		{
            return (misfireInstruction == X_Quartz.MisfireInstruction.SimpleTrigger.FireNow) 
                || (misfireInstruction == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNextWithExistingCount) 
                || (misfireInstruction == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNextWithRemainingCount)
                || (misfireInstruction == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNowWithExistingRepeatCount)
                || (misfireInstruction == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNowWithRemainingRepeatCount)
                || (misfireInstruction == X_Quartz.MisfireInstruction.SmartPolicy);
		...
		public override void UpdateAfterMisfire(ICalendar cal)
		{
			...
			if (instr == X_Quartz.MisfireInstruction.SmartPolicy)
			{
				if (RepeatCount == 0)
				{
                    instr = X_Quartz.MisfireInstruction.SimpleTrigger.FireNow;
				}
				else if (RepeatCount == RepeatIndefinitely)
				{
                    instr = X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNextWithRemainingCount;
					    
				}
				else
				{
                    instr = X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNowWithExistingRepeatCount;
				}
			}
            else if (instr == X_Quartz.MisfireInstruction.SimpleTrigger.FireNow && RepeatCount != 0)
			{
                instr = X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNowWithRemainingRepeatCount;
			}

            if (instr == X_Quartz.MisfireInstruction.SimpleTrigger.FireNow)
			{
				SetNextFireTime(DateTime.UtcNow);
			}
			else if (instr == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNextWithExistingCount)
			{
			...
			else if (instr == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNextWithRemainingCount)
			{
                NullableDateTime newFireTime = GetFireTimeAfter(DateTime.UtcNow);
			...
			else if (instr == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNowWithExistingRepeatCount)
			{
			...
			else if (instr == X_Quartz.MisfireInstruction.SimpleTrigger.RescheduleNowWithRemainingRepeatCount)
			{
				DateTime newFireTime = DateTime.UtcNow;
				int timesMissed = ComputeNumTimesFiredBetween(nextFireTimeUtc, newFireTime);
