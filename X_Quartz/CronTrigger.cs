...
namespace X_Quartz
{
	...
	public class CronTrigger : Trigger
	{
		...
		{
            return (misfireInstruction == X_Quartz.MisfireInstruction.CronTrigger.DoNothing) 
                || (misfireInstruction == X_Quartz.MisfireInstruction.CronTrigger.FireOnceNow)
		...
		/// <summary>
		/// This method should not be used by the X_Quartz client.
		/// <p>
		...
		public override void UpdateAfterMisfire(ICalendar cal)
		{
			...
			{
				instr = X_Quartz.MisfireInstruction.CronTrigger.FireOnceNow;
			}

			if (instr == X_Quartz.MisfireInstruction.CronTrigger.DoNothing)
			{
			...
			else if (instr == X_Quartz.MisfireInstruction.CronTrigger.FireOnceNow)
			{
