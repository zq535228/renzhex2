...
namespace X_Quartz
{
	...
	public abstract class Trigger : ICloneable, IComparable
	{
        ...
        private int misfireInstruction = X_Quartz.MisfireInstruction.InstructionNotSet;
		...
		/// <p>
        /// If not explicitly set, the default value is <see cref="X_Quartz.MisfireInstruction.InstructionNotSet" />.
		/// </p>
		/// </summary>
        /// <seealso cref="X_Quartz.MisfireInstruction.InstructionNotSet" />
        ...
        /// two <see cref="Trigger" />s have the same scheduled fire time, then X_Quartz
