...
namespace X_Quartz
{
	...
	public class SchedulerMetaData
	{
		...
		/// <summary>
		/// Returns the version of X_Quartz that is running.
		/// </summary>
		...
		/// <pre>
		/// X_Quartz Scheduler 'SchedulerName' with instanceId 'SchedulerInstanceId' Scheduler class: 'X_Quartz.Impl.StdScheduler' - running locally. Running since: '11:33am on Jul 19, 2002' Not currently paused. Number of Triggers fired: '123' Using thread pool 'X_Quartz.Simpl.SimpleThreadPool' - with '8' threads Using job-store 'X_Quartz.Impl.JobStore' - which supports persistence.
		/// </pre>
		/// </p>
		/// </remarks>
		public string GetSummary()
		{
			StringBuilder str = new StringBuilder("X_Quartz Scheduler (v");
			str.Append(Version);
			str.Append(") '");
