...
namespace X_Quartz.Impl.AdoJobStore
{
    ...
    public class SQLiteDelegate : StdAdoDelegate
    {
        ...
        public SQLiteDelegate(ILog logger, string tablePrefix, string instanceId, IDbProvider dbProvider) : base(logger, tablePrefix, instanceId, dbProvider)
        {
        }
        ...
        public SQLiteDelegate(ILog logger, string tablePrefix, string instanceId, IDbProvider dbProvider, bool useProperties)
