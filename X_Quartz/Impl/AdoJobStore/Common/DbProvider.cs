...
namespace X_Quartz.Impl.AdoJobStore.Common
{
    /// <summary>
    ///     
    /// </summary>
    ...
    {
        protected const string PropertyDbProvider = "X_Quartz.dbprovider";
        protected const string DbProviderResourceName = "X_Quartz.Impl.AdoJobStore.Common.dbproviders.properties";
