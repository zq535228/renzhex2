...
namespace X_Quartz.Impl.AdoJobStore
{
    ...
    public class FirebirdDelegate : StdAdoDelegate
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FirebirdDelegate"/> class.
        /// </summary>
        ...
        public FirebirdDelegate(ILog logger, string tablePrefix, string instanceId, IDbProvider dbProvider) : base(logger, tablePrefix, instanceId, dbProvider)
        {
        ...
        public FirebirdDelegate(ILog logger, string tablePrefix, string instanceId, IDbProvider dbProvider, bool useProperties)
            : base(logger, tablePrefix, instanceId, dbProvider, useProperties)
        {
            CreateSqlForSelectNextTriggerToAcquire();
        }
        ...
        private void CreateSqlForSelectNextTriggerToAcquire()
        {
            ...
            sqlSelectNextTriggerToAcquire = "SELECT FIRST " + TriggersToAcquireLimit + " " + sqlSelectNextTriggerToAcquire.Substring(6);
        }
