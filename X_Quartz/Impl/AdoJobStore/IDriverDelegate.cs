...
namespace X_Quartz.Impl.AdoJobStore
{
	...
	public interface IDriverDelegate
	{
		...
		Key[] SelectTriggerNamesForJob(ConnectionAndTransactionHolder conn, string jobName, string groupName);
        ...
        IList SelectTriggerToAcquire(ConnectionAndTransactionHolder conn, DateTime noLaterThan, DateTime noEarlierThan);
