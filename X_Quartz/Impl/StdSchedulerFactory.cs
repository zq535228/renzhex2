...
using X_Quartz.Collection;
using X_Quartz.Core;
using X_Quartz.Impl.AdoJobStore;
using X_Quartz.Impl.AdoJobStore.Common;
using X_Quartz.Simpl;
using X_Quartz.Spi;
using X_Quartz.Util;

namespace X_Quartz.Impl {
    /// <summary>
    ...
    /// If that fails, then the "X_Quartz.properties"
    /// file located (as a embedded resource) in X_Quartz.dll is loaded. If you
    ...
    /// 
    /// <p>
    /// See the sample properties that are distributed with X_Quartz for
    ...
    public class StdSchedulerFactory : ISchedulerFactory {
        public const string PropertiesFile = "X_Quartz.config";
        public const string PropertySchedulerInstanceName = "X_Quartz.scheduler.instanceName";
        public const string PropertySchedulerInstanceId = "X_Quartz.scheduler.instanceId";
        public const string PropertySchedulerInstanceIdGeneratorPrefix = "X_Quartz.scheduler.instanceIdGenerator";
        public const string PropertySchedulerInstanceIdGeneratorType = PropertySchedulerInstanceIdGeneratorPrefix + ".type";
        public const string PropertySchedulerThreadName = "X_Quartz.scheduler.threadName";
        public const string PropertySchedulerExporterPrefix = "X_Quartz.scheduler.exporter";
        public const string PropertySchedulerExporterType = PropertySchedulerExporterPrefix + ".type";
        public const string PropertySchedulerProxy = "X_Quartz.scheduler.proxy";
        public const string PropertySchedulerProxyAddress = "X_Quartz.scheduler.proxy.address";
        public const string PropertySchedulerIdleWaitTime = "X_Quartz.scheduler.idleWaitTime";
        public const string PropertySchedulerDbFailureRetryInterval = "X_Quartz.scheduler.dbFailureRetryInterval";
        public const string PropertySchedulerMakeSchedulerThreadDaemon = "X_Quartz.scheduler.makeSchedulerThreadDaemon";
        public const string PropertySchedulerTypeLoadHelperType = "X_Quartz.scheduler.typeLoadHelper.type";
        public const string PropertySchedulerJobFactoryType = "X_Quartz.scheduler.jobFactory.type";
        public const string PropertySchedulerJobFactoryPrefix = "X_Quartz.scheduler.jobFactory";
        public const string PropertySchedulerContextPrefix = "X_Quartz.context.key";
        public const string PropertyThreadPoolPrefix = "X_Quartz.threadPool";
        public const string PropertyThreadPoolType = "X_Quartz.threadPool.type";
        public const string PropertyJobStorePrefix = "X_Quartz.jobStore";
        ...
        public const string PropertyJobStoreType = "X_Quartz.jobStore.type";
        public const string PropertyJobStoreUseProperties = "X_Quartz.jobStore.useProperties";
        public const string PropertyDataSourcePrefix = "X_Quartz.dataSource";
        ...
        public const string PropertyPluginPrefix = "X_Quartz.plugin";
        public const string PropertyPluginType = "type";
        public const string PropertyJobListenerPrefix = "X_Quartz.jobListener";
        public const string PropertyTriggerListenerPrefix = "X_Quartz.triggerListener";
        ...
        /// 
        /// <p>
        /// By default a properties file named "X_Quartz.properties" is loaded from
        /// the 'current working directory'. If that fails, then the
        /// "X_Quartz.properties" file located (as a resource) in the org/quartz
        ...
        public void Initialize ( ) {
            ...
            if ( props == null && File.Exists(propFileName) ) {
                ...
                try {
                    ...
                    Log.Info(string.Format("X_Quartz.NET properties loaded from configuration file '{0}'" , propFileName));
                } catch ( Exception ex ) {
                    Log.Error(
                        string.Format(CultureInfo.InvariantCulture ,
                        "Could not load properties for X_Quartz from file {0}: {1}" ,
                        propFileName ,
                        ex.Message) , ex);
                }
            ...
            if ( props == null ) {
                // read from assembly
                try {
                    PropertiesParser pp = PropertiesParser.ReadFromEmbeddedAssemblyResource("X_Quartz.quartz.config");
                    props = pp.UnderlyingProperties;
                    Log.Info("Default X_Quartz.NET properties loaded from embedded resource file");
                } catch ( Exception ex ) {
                    Log.Error(
                        string.Format(CultureInfo.InvariantCulture , "Could not load default properties for X_Quartz from X_Quartz assembly: {0}" ,
                                      ex.Message) , ex);
                }
            }
            if ( props == null ) {
...
Please add configuration to your application config file to correctly initialize X_Quartz.");
            }
        ...
        private IScheduler Instantiate ( ) {
            ...
            if ( schedInstId.Equals(AutoGenerateInstanceId) ) {
                ...
                instanceIdGeneratorType =
                    cfg.GetStringProperty(PropertySchedulerInstanceIdGeneratorType ,
                                          "X_Quartz.Simpl.SimpleInstanceIdGenerator, X_Quartz");
            }


            typeLoadHelperType =
                cfg.GetStringProperty(PropertySchedulerTypeLoadHelperType ,
                                      "X_Quartz.Simpl.CascadingClassLoadHelper, X_Quartz");
            ...
            Log.Info(string.Format(CultureInfo.InvariantCulture , "X_Quartz scheduler '{0}' initialized" , sched.SchedulerName));

            Log.Info(string.Format(CultureInfo.InvariantCulture , "X_Quartz scheduler version: {0}" , qs.Version));
